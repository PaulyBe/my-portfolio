...
import { FaHtml5, FaCss3Alt, FaGithub, FaReact, FaWordpress } from "react-icons/fa";
...
const timelineData: TimelineItem[] = [
  {
    description: 'I moved to Vienna in 2020 to pursue my Master´s degree in International Business Administrationm, with a focus on Data Science. While studying I also started working in consulting.',
    iconType: 'building',
  },
  {
    description: 'During my studies and my time in consulting, I developed an interest in programming. Therefore, I decided to leave consulting to study frontend development.',
    iconType: 'consulting',
  },
  {
    description: 'I enrolled in a program by Meta, called Meta Frontend Developer. The program focused on web development, especially with HTML, CSS and JavaScript. Furthermore, the course taught developing web applications in React.',
    iconType: 'onlinelearning',
  },
  {
    description: 'Since completing the course, I have engaged in various projects to enhance my coding skills and develop a comprehensive professional portfolio.',
    iconType: 'coder',
  },
  {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative pt-4">
          ...
          <div className="flex flex-wrap items-center justify-center max-w-xl gap-4 md:gap-8 pt-10 pb-20 mx-auto">
            ...
            <div className="w-20 h-20 md:w-28 md:h-28 rounded-full bg-white flex items-center justify-center shadow-md">
              <span className="block md:hidden"><FaReact size={48} color="#61dbfb"/></span>
              <span className="hidden md:block"><FaReact size={70} color="#61dbfb"/></span>
            </div>
            <div className="w-20 h-20 md:w-28 md:h-28 rounded-full bg-white flex items-center justify-center shadow-md">
            ...
            <div className="w-20 h-20 md:w-28 md:h-28 rounded-full bg-white flex items-center justify-center shadow-md">
              <span className="block md:hidden"><FaWordpress size={48} color="#21759B"/></span>
              <span className="hidden md:block"><FaWordpress size={70} color="#21759B"/></span>
            </div>
            <a
